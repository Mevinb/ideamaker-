...
const participants = ["Explorer", "Challenger", "Builder", "Connector"];
...
export default function Home() {
  ...
  return <main>
    ...
    <div className="page" id="top">
      <header className="intro"><span className="kicker">Local AI discussion</span><h1>Talk an idea into shape.</h1><p>Bring an idea to four models. They respond to each other, challenge assumptions, and build on promising directions. Jump in whenever you have a thought.</p></header>
